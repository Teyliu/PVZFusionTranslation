...
namespace PvZ_Fusion_Translator__BepInEx_.Patches.Managers
{
	...
	public static class AbyssMenu2_Patch
	{
		private static void UpdateAbyss2Text(AbyssMenu2 __instance)
		{
			...
			foreach (TextMeshProUGUI textMesh in optionsTransform.GetComponentsInChildren<TextMeshProUGUI>())
			{
		...
		private static void Start(AbyssMenu2 __instance)
		{
			...
			// custom bag text
			__instance.transform.FindChild("Bag").FindChild("text").GetComponent<UnityEngine.UI.Text>().text += "_深渊";
